...
# Ascend optimized kernels can be unstable for RLHF-style VL training.
...
rollout_log_prob_micro_batch_size=${ROLLOUT_LOGPROB_MICRO_BATCH_SIZE:-2}
ref_log_prob_micro_batch_size=${REF_LOGPROB_MICRO_BATCH_SIZE:-2}
rollout_gpu_memory_utilization=${ROLLOUT_GPU_MEMORY_UTILIZATION:-0.45}
rollout_max_num_seqs=${ROLLOUT_MAX_NUM_SEQS:-64}
rollout_chunked_prefill=${ROLLOUT_ENABLE_CHUNKED_PREFILL:-False}
